      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 flex flex-col bg-white overflow-y-auto">
          <div className="flex items-center px-8 py-6 border-b border-gray-100">
            <h1 className="text-2xl font-semibold text-gray-700">Create training log</h1>
          </div>
        </main>
      </div>
    </div>
            ...
            <form className="space-y-6 w-full max-w-4xl">
              ...
              <div>
                ...
                <div className="relative">
                  <select className="w-full p-3 border border-gray-300 rounded-lg bg-white appearance-none cursor-pointer focus:outline-none focus:ring-1 focus:ring-gray-400">
                    <option>Lucy - Golden Retriever</option>
                    <option>Buddy - Beagle</option>
                  </select>
